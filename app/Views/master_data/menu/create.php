    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        <form action="<?= base_url() ?>/menu/store" method="POST" id="myForm">
                            <?= csrf_field() ?>
                            <input type="text" class="form-control <?= ($validation->hasError('nama_menu')) ? 'is-invalid' : ''; ?>" name="nama_menu" id="nama_menu" placeholder="Nama Group" value="<?= old('nama_menu'); ?>" autofocus>
